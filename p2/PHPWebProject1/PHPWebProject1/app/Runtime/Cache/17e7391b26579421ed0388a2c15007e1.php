  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
			...
			<li><a href="index.php?m=Index&a=users">Sample List</a></li>
			<li><a href="index.php?m=Index&a=user">Sample Item</a></li>
			<li><a href="index.php?m=Index&a=media">Media</a></li>
			<li><a href="index.php?m=Index&a=calendar">Calendar</a></li>
            
        </ul>

        <a href="#accounts-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>Account<span class="label label-info">+3</span></a>
        <ul id="accounts-menu" class="nav nav-list collapse">
			<li><a href="index.php?m=Index&a=signIn">Sign In</a></li>
			<li><a href="index.php?m=Index&a=signOut">Sign Up</a></li>
			<li><a href="index.php?m=Index&a=resetPassword">Reset Password</a></li>
        </ul>
